"""
    ...
    All tokens (Fixed No.) introduced at the starting of an environment
"""
...
class ConveyorEnv_A(gym.Env):
    ...
    def reset(self):
        ...
        self.binding['T'] = {}
        if self.state_extension:
            self.token_state = [0 for _ in range(40)]
    ...
    def _calculate_reward(self):
        ...
        if self.final_reward == 'A':
            ...
            self.reward = - 5 * self.terminating_in_middle + 5 * self.done * (not self.terminating_in_middle)
