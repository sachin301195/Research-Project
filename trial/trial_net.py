...
class TrialNet:
    ...
    def network(self, bounds = 5, minimum_time = 0, maximum_time = 5):
        ...
        n.add_input('S', 't_SA', Tuple([Variable('dir'), Variable('c'), Variable('f'), Variable('count')]))
        n.add_output('A', 't_SA', Tuple([Expression('dir + 1'), Variable('c'), Variable('f'), Expression('count + 1')]))
